...
//----------------------------------------------------------------
$query = ("UPDATE employeedata SET duplicate_card_issue_reason='".$_POST['duplicate_reason']."',print_on_date = CURRENT_TIMESTAMP() WHERE user_id = ".$_POST['user_id']);
// echo $query;
...
$sql = "SELECT * FROM employeedata WHERE user_id =".$_POST['user_id'];
$result = $db->query($sql);
